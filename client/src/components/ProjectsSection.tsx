...
const projects: Project[] = [
  ...
  },
  {
    id: 3,
    type: "individual",
    title: "App Clima em Tempo Real",
    description:
      "Aplicativo mobile que fornece previsão do tempo com mapas interativos, alertas de tempestade e histórico de dados climáticos.",
    techs: ["React Native", "Firebase", "OpenWeather API", "Mapbox"],
    github: "#",
    demo: "#",
    featured: false,
    year: "2024",
  },
  {
    ...
    description:
      "Painel de análise de dados em tempo real com gráficos interativos, filtros avançados e exportação de relatórios em múltiplos formatos.",
  ...
  },
  {
    ...
    description:
      "Site de portfólio pessoal com animações suaves, dark mode, integração com GitHub e otimizado para SEO.",
